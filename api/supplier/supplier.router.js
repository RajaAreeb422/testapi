...
router.put("/uploadBrandLogo/:id",  upload.single('imageFile'),use(uploadCollectionImage));
router.put("/uploadBrandHead/:id",  upload.single('imageFile'),use(uploadHeadImage));
