...
router.get("/getCategoryByCollectionId/:id",use(getCategoryByCollectionId));
router.get("/getCategoriesBySupplierId/:id",use(getCategoriesBySupplierId));
...
router.post("/uploadImage/:id",  upload.single('imageFile'),use(uploadCategoryImage));
