...
module.exports = {
  ...
  getCollectionByCategoryId: (req, res) => {
    const id = req.params.id;
    getCollectionByCategoryId(id, (err, results) => {
        if (err) {
          console.log(err);
          return res.status(500).json({
            success: 0,
    ...
    getCollectionByBrandId: (req, res) => {
    const id = req.params.id;
    getCollectionByBrandId(id, (err, results) => {
        if (err) {
          console.log(err);
          return res.status(500).json({
            success: 0,
